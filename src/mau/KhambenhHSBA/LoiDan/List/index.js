import { Table, Button, Dropdown, Form, Input, Result } from "antd";
...
import "../loidan.scss";
import Ctkhaibaoloidan from "../Detail";
function LoiDan() {
                ...
                <div className="text-muted">
                    <div className="d-flex justify-content-between align-items-center mt-2 mx-2">
                        <div className="d-flex align-items-center ">
                            <div className="vienphi-danhmuc-title mx-2">Danh mục lời dặn</div>
                        </div>
                    ...
                    <Ctkhaibaoloidan open={open} setOpen={setOpen} />
